...
class ClientesTest < ApplicationSystemTestCase
  ...
  test "creating a Cliente" do
    ...
    fill_in "Fec crea", with: @cliente.fec_crea
    fill_in "Fec mod", with: @cliente.fec_mod
    fill_in "Numero documento", with: @cliente.numero_documento
    fill_in "Tipo documento", with: @cliente.tipo_documento
    fill_in "Usu crea", with: @cliente.usu_crea
    fill_in "Usu mod", with: @cliente.usu_mod
